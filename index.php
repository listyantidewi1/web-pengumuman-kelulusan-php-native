...
<head>
    ...
    <meta name="description" content="Portal Pengumuman Kelulusan SMK Negeri 12 Malang Tahun 2022/2023">
    <meta name="author" content="dewi@smkn12malang.sch.id">
    <title>Pengumuman Kelulusan SMK Negeri 12 Malang - 2022</title>
...
<body>
    ...
    <div class="container">
        <img src="http://smkn12malang.sch.id/in/wp-content/uploads/2018/10/cropped-logo.jpg" width=100/>
        <img src="https://th.bing.com/th/id/OIP.bDFlDZfb8a5WnAWmGHJx6QHaFj?pid=ImgDet&rs=1" width=350/>
    </div>
    ...
    <div class="container">
		...
		?>
			<table class="table table-bordered">
				<tr><td>Nomor Induk Siswa</td><td><?= htmlspecialchars($data['no_ujian']); ?></td></tr>
		...
		?>
        <p>Masukkan nomor indukmu pada form yang disediakan.</p>
        
        <form method="post">
            <div class="input-group">
                <input type="text" name="nomor" class="form-control" placeholder="Nomor Induk / NIS" required>
